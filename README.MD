...
- Abra **3 PowerShell** ou terminais separados, mas todos precisam estar conectados entre si para garantir a comunicação. Execute os seguintes comandos nos terminais:
