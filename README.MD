...
1. **Rodando o Servidor**
   ...
   Abra 2 PowerShell ou terminal para executar com seguinte comando para iniciar o servidor:
   ```powershell
   
   python client.py


   Abra somente 1 PowerShell ou terminal e execute o seguinte comando para iniciar o servidor:
   ```powershell
